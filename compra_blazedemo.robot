...
Compra de Passagem
    ...
    Quando sleciono a origem como "São Paolo"
    E o destino como "London"
    E clico no botao Find Flights
    Entao exibe uma lista de voos da origem para o trecho desejado
    Quando seleciono o primeiro voo disponivel
    E preencho o nome como "Samantha"
...
Quando sleciono a origem como "${origem}"
